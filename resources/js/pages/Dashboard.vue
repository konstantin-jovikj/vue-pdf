    ...
    <AppLayout :breadcrumbs="breadcrumbs" class="h-full">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl bg-red-100 p-4">
            <div class="grid h-full auto-rows-max gap-4 bg-blue-100 md:grid-cols-2">
                <div
                    class="relative h-full overflow-hidden rounded-xl border border-sidebar-border/70 bg-slate-400 p-8 dark:border-sidebar-border">
                    <form @submit.prevent="
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="varijanta" type="text" required autofocus :tabindex="1" autocomplete="varijanta"
                                v-model="form.varijanta" placeholder="Varijanta" />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="file" @change="handleFileChange" type="file" accept="application/pdf" required
                                autofocus :tabindex="1" autocomplete="file" />
                ...
                <div
                    class="relative overflow-hidden rounded-xl border border-sidebar-border/70 bg-slate-300 dark:border-sidebar-border">
